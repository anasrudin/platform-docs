"""S3-compatible BlobStore (MinIO / AWS S3 / Cloudflare R2)."""
...
class Store:
    ...
    def upload(self, artifact_id: str, name: str, src: io.IOBase) -> str:
        """Write src to MinIO at <bucket>/<artifact_id>/<name>. Returns the key."""
...
__all__ = ["Config", "Store", "ensure_local_dir", "local_path", "mc_available"]
