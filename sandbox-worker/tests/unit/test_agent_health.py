...
class TestStartHealthServer:
    def test_starts_daemon_thread(self):
        ...
        import adapters.registry.health_server as hs

        mock_thread = MagicMock()
        mock_server = MagicMock()

        with patch("adapters.registry.health_server.uvicorn.Config"), \
             patch("adapters.registry.health_server.uvicorn.Server",
                   return_value=mock_server), \
             patch("adapters.registry.health_server.threading.Thread",
